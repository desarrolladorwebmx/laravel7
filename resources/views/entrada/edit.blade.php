          ...
          <div class="col-sm-7">
              <div class="form-group">
                <label for="titulo">Titulo</label>
                 <input type="text"  class="form-control" name="titulo" id="titulo" placeholder="Titulo" value="{{$entrada->titulo}}">
              </div>
              <div class="form-group">
                  <label for="contenido">Contenido</label>
                   <textarea  class="form-control" name="contenido" id="contenido" placeholder="contenido" cols="30" rows="10">{{$entrada->contenido}}</textarea>
              </div>
          </div>
